...
/** Sets up date select boxes and provides functionality. */
function setupListeners() {
    ...
    nextPickup = isPickupDate(nextPickup) ? nextPickup : getNextPickupDateFrom(nextPickup);
...
/** Takes in an array of dates and returns them in HTML "option" tags. */
...
/** Sets up the table for the todo orders or the completed orders. */
...
/** Creates pagination menu on the bottom of the table depending on how many orders and how many orders per page are being viewed. */
...
/** Retrieves orders on a given page number (also must specify the table, types of orders, and how many displayed orders per page. */
...
/** Changes status of an order when checkbox is checked. */
...
/** Adds suffix to make normal number ordinal number. */
